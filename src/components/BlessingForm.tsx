...
export function BlessingForm() {
  ...
  return (
    <motion.form
      ...
      className="max-w-xl mx-auto bg-white/60 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-pink-100"
    >
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-serif text-[#000000] mb-2 font-semibold">
            Your Name
          </label>
          <input
            {...register('name', { required: 'Name is required' })}
            className="w-full px-4 py-3 rounded-xl border border-pink-200 bg-white focus:outline-none focus:ring-2 focus:ring-[#E60000]/50"
            placeholder="Name"
          />
        </div>
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl border border-pink-200 bg-white focus:outline-none focus:ring-2 focus:ring-[#E60000]/50 resize-none"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-4 bg-gradient-to-r from-[#E87A90] to-[#000000] text-white rounded-xl font-serif text-lg shadow-lg flex items-center justify-center gap-2"
        >
